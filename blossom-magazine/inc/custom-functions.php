...
function blossom_magazine_admin_notice() {
    ...
    $dismissnonce   = wp_create_nonce( 'blossom_magazine_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=blossom-magazine-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the dashboard.', 'blossom-magazine' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?blossom_magazine_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'blossom-magazine' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function blossom_magazine_update_admin_notice(){
    ...
    if ( isset( $_GET['blossom_magazine_admin_notice'] ) && $_GET['blossom_magazine_admin_notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'blossom_magazine_admin_notice' )) {
...
function blossom_magazine_dynamic_mce_css_ajax_callback(){
    ...
    $secondary_font  = get_theme_mod( 'secondary_font', 'Source Serif 4' );
