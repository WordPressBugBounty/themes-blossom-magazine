...
Blossom Magazine local fonts feature is based on Webfonts Loader by WordPress Themes Team (WPTT). (https://github.com/WPTT/webfont-loader)
License: MIT
...
== Changelog ==
    ...
    * Update: Now users can add Instagram shortcode from any plugins of their choice
    ...
    1.0.6 - June 30, 2023
    * Updated: Google Fonts Library has been updated.
    * Updated: Relevant tags for the theme have been added.
    * Updated: Changed default secondary font to Source Serif 4.
    * Fix: Warning shown in PHP 8 during plugin installation through TGMPA has been fixed.

    1.0.5 - July 15, 2022
    * Added: feature to load google font locally

    1.0.4 - June 29, 2022
    * Fix: Slider button design issue
    * Fix: Blog page font family issue
    * Added: Settings for footer text color and footer background color
    * Updated: Google Fonts library
    * Added: Tiktok icon to social media settings
